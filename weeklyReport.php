...
<head>
    ...
    <title>Weekly Funding Test</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Weekly Funding Report</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                        ...
                        <form action="" method="POST" class="">
                            <div class="row no-print">
                                ...
                                <div class="col-md-3" style="text-align: right">
                                    ...
                                    onclick="window.open('weeklyReport.php', '_self');" style="background-color:#E7D7B7; border-radius:5px; width: 100px;">Reset</button>
                                </div>
                            </div>
