...
$sqlDelete = 'DELETE FROM lsuform WHERE Id = ' . $lsu_id;
$result = $conn->query($sqlDelete);
$sql =
	'INSERT INTO `lsuform`(`Id`, `Client`, `Dept`, `FirstName`, `LastName`, `SSN`, `Specimen`, `Collection`, `Account`, `Fund`, `Department`, `Program`, `Class`, `Project`, `Contact`, `Email`, `RequestedBy`, `RequestedDate`, `Deadline`, `TestType`, `Reason`, `Type2`, `Type3`, `Safety`, `Comments`,`userid`) VALUES ("' .
	$lsu_id .
	'","' .
	$client .
	'","' .
...
$sql = 'SELECT * FROM lsuform WHERE Id = ' . $lsu_id;
$result = $conn->query($sql);
