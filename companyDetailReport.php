            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Company Detail Report</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>

                                    <li class="breadcrumb-item active">Company Detail Report</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                                ...
                                <table id="table_users" class="table">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th scope="col">LastOftest_date</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    $sql1 =
                                        'SELECT * FROM divisions JOIN accounts ON divisions.account_id = accounts.account_id  ORDER BY accounts.account_nm';
                                    // echo $sql1;
                                    ...
                                    while ($row1 = $result1->fetch_assoc()) {
                                        ...
                                        $sqlTest = 'SELECT MAX(test_date) FROM test WHERE account_id = ' . $row1['account_id'] . ' AND division_id = ' . $row1['division_id'];
                                        ...
                                        if($resultTest->num_rows > 0) {
                                            ...
                                            '</td>
                                            <td>' .
                                            date('d-M-Y', strtotime($rowTest['MAX(test_date)'])).
                                            '</td>';
                                            // echo '
                                            //       <td></td>
                                            //       <td></td>
