...
<head>
    ...
    <title>Account Usage Report</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Account Usage Report</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>

                                    <li class="breadcrumb-item active">Account Usage Report</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                        <form action="" method="POST" class="">
                            ...
                            <div class="row no-print"> -->
                                ...
                                <div class="col-md-3" style="text-align: right">
                                    ...
                                    <button type="button" class="btn mt-2" onclick="window.open('accountUsageReport.php', '_self');" style="background-color:#E7D7B7; border-radius:5px; width: 100px;">Reset</button>
                                </div>
                            </div>

                            <!-- </form> -->
                            <!-- <br><br> -->
                            <?php if (isset($_GET['account']) && isset($_POST['account_nm'])) { ?>
                                <!-- <form action="" method="POST" class=""> -->
                                <div class="row no-print">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        if (
                                            ...
                                            $sqlDate =
                                                ' AND ((test.collection_date BETWEEN "' .
                                                $date_start_filter .
                                                '" AND "' .
                                                $date_end_filter .
                                                '"))';
                                ...
                                <table id="table_users" class="table table-responsive">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th scope="col">CountOfsample_nm</th>
                                            <th scope="col">Expr1
                                            Sample Type
                                            </th>
                                            <th scope="col">MinOfamount</th>
                                            <th scope="col">SumOfamount</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    $sql1 = 'SELECT LATeststbl.account_nm, Count(LATeststbl.sample_nm) AS CountOfsample_nm, LATeststbl.sample_nm AS Expr1, Min(LATeststbl.amount) AS MinOfamount, Sum(LATeststbl.amount) AS SumOfamount FROM (SELECT test.emp_id, accounts.account_nm, test.amount, sample_nm 
                                    FROM ((((test INNER JOIN accounts ON test.account_id = accounts.account_id) INNER JOIN testtype ON test.type_id = testtype.type_id) INNER JOIN employees ON (test.account_id = employees.account_id) AND (test.emp_id = employees.emp_id)) INNER JOIN reasons ON test.reason_id = reasons.reason_id) INNER JOIN sampletype ON test.sample_id = sampletype.sample_id
                                    WHERE (((accounts.account_nm) Like "%'.$_POST['account_nm'].'%") AND ((test.amount)<>0) '.$sqlDate.')
                                    ORDER BY accounts.account_nm) AS LATeststbl GROUP BY LATeststbl.account_nm, LATeststbl.sample_nm;
                                    ...
                                    while ($row1 = $result1->fetch_assoc()) {
                                        ...
                                        echo '</td>
                                        <td>' .
                                            $row1['CountOfsample_nm'] .
                                            '</td>
                                        <td>' .
                                            $row1['Expr1'] .
                                            '</td>
                                        <td>$ ' .
                                            number_format(floatval($row1['MinOfamount']), 2) .
                                            '</td>
                                        <td>$ ' .
                                            number_format(floatval($row1['SumOfamount']), 2) .
                                        '</td>';
                                        // echo '
                                        //       <td></td>
                                        //       <td></td>
