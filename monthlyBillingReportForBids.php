...
<head>
    ...
    <title>Monthly Billing Report for Bids</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Monthly Billing Report for Bids</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>

                                    <li class="breadcrumb-item active">Monthly Billing Report for Bids</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                        <form action="" method="POST" class="">
                            <div class="row no-print">
                                ...
                                <div class="col-md-3" style="text-align: right">
                                    ...
                                    <button type="button" class="btn mt-2" onclick="window.open('monthlyBillingReportForBids.php', '_self');" style="background-color:#E7D7B7; border-radius:5px; width: 100px;">Reset</button>
                                </div>
                            </div>
                            ...
                            <?php if (isset($_GET['account']) && isset($_POST['account_nm'])) { ?>
                                ...
                                <table id="table_users" class="table table-responsive">
                                    ...
                                    WHERE (((accounts.account_nm) Like "'.$_POST['account_nm'].'"))
                                    ORDER BY accounts.account_nm, test.invoice_id;                                    
                                    ';
                                    // echo $sql1;
