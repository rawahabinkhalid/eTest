...
<head>
    ...
    function propertiesClicked() {
        ...
        document.getElementsByClassName('modal-title')[0].innerHTML = 'Edit Type';
        $.ajax({
            type: "GET",
            url: "getAllData.php?testtype_id=" + selected_testtype,
            success: function(resultData) {
                var data = JSON.parse(resultData);
                $('#testtype_id').val(selected_testtype);
                $('#testtype').val(data.type_nm);
            }
        });
    }
    ...
    function deleteClicked() {
        $.ajax({
            type: "GET",
            url: "insert_testtype.php?delete_testtype_id=" + selected_testtype,
            success: function(resultData) {
                // console.log(resultData);
                window.open("testtype.php", "_self");
    ...
    function addClicked() {
        document.getElementsByClassName('modal-title')[0].innerHTML = 'New Type';
    }

    function testtypeSelected(id) {
        $('#table_testtype > tbody  > tr').each(function(index, tr) {
            tr.style.background = 'rgba(0,0,0,.05)';
        });
        selected_testtype = id;
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Test Type Maintenance</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>
                                    
                                    <li class="breadcrumb-item active">Test Type Maintenance</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                        ...
                        <form action="" method="POST" class="">
                            <div class="row">
                                <div class="col-md-8" style="overflow-y:scroll; overflow-x:scroll;">
                                    <table id="table_testtype" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
...
while ($row = mysqli_fetch_assoc($result)) {
    $id = $row['type_id'];
    echo '
                                                        <tr id="' . $id . '" onclick = "testtypeSelected(' . $id . ');">
