...
<head>
    ...
    function propertiesClicked() {
        // var selected_testtype = i;
        document.getElementsByClassName('modal-title')[0].innerHTML = 'Edit Test Reason';
        $.ajax({
            type: "GET",
            url: "getAllData.php?testreason_id=" + selected_testreason,
            success: function(resultData) {
                var data = JSON.parse(resultData);
                $('#testreason_id').val(selected_testreason);
                $('#resoncode').val(data.reason_code);
                $('#reason').val(data.reason_nm);
    ...
    function deleteClicked() {
        $.ajax({
            type: "GET",
            url: "insert_testreason.php?delete_reason_id=" + selected_testreason,
            success: function(resultData) {
                // console.log(resultData);
                window.open("testreason.php", "_self");
    ...
    function addClicked() {
        document.getElementsByClassName('modal-title')[0].innerHTML = 'New Test Reason';
    }

    function testreasonSelected(id) {
        $('#table_testreason > tbody  > tr').each(function(index, tr) {
            console.log(tr.style.background = 'rgba(0,0,0,.05)');
        });

        selected_testreason = id;
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Test Reason Maintenance</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>
                                    
                                    <li class="breadcrumb-item active">Test Reason Maintenance</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                        ...
                        <form action="" method="POST" class="">
                            <div class="row">
                                <div class="col-md-8" style="overflow-y:scroll; overflow-x:scroll;">
                                    <table id="table_testreason" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
...
while ($row = mysqli_fetch_assoc($result)) {
    $id = $row['reason_id'];
    echo '
                                                         <tr id="' . $id . '" onclick = "testreasonSelected(' . $id . ');">
...
?>
            ...
            <div id="myModal" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <!-- Modal content-->
                    <form action="insert_testreason.php" method="post">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">New Test Reason</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body" style="display: inline-block">
                                <div class="row">
                                    <input type="hidden" id="testreason_id" name="testreason_id">
                                    <div class="col-md-2" style="display: inline-block">Reason Code: </div>
                                    <div class="col-md-2" style="display: inline-block"><input required class="form-control"
                                            id="resoncode" name="resoncode">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2" style="display: inline-block">Reason: </div>
