            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Email Report</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                        ...
                        <form action="" method="POST" class="">
                            ...
                            <?php if (isset($_GET['account']) && (isset($_POST['account_nm']) || isset($_POST['invoice_id']) || isset($_POST['last_nm']))) { ?>
                                ...
                                <table id="table_users" class="table table-responsive">
                                    ...
                                    $sql1 = 'SELECT accounts.account_nm, divisions.division_nm, divisions.email
                                    FROM test INNER JOIN (divisions INNER JOIN accounts ON divisions.account_id = accounts.account_id) ON test.account_id = accounts.account_id
                                    GROUP BY accounts.account_nm, divisions.division_nm, divisions.email, divisions.address, divisions.city, divisions.state, divisions.zip, divisions.contact, divisions.phone
                                    HAVING (((accounts.account_nm) Like "%' . $account_nm . '%"))
