...
<head>
    ...
    <title>Company Tested for a Certain Drug</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Company Tested for a Certain Drug</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>

                                    <li class="breadcrumb-item active">Company Tested for a Certain Drug</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                        <form action="" method="POST" class="">
                            ...
                            <div class="row no-print"> -->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select style="width: 240px; height: 31px;" id="testtype" name="account_nm">
                                            ...
                                            if ($result->num_rows > 0) {
                                                while (
                                                    ...
                                                    if(isset($_POST['account_nm']))
                                                        if($row['type_nm'] == $_POST['account_nm'])
                                                            echo 'selected';
                                ...
                                <div class="col-md-3" style="text-align: right">
                                    ...
                                    <button type="button" class="btn mt-2" onclick="window.open('companyDrugReport.php', '_self');" style="background-color:#E7D7B7; border-radius:5px; width: 100px;">Reset</button>
                                </div>
                            </div>
                            ...
                            <?php if (isset($_GET['account']) && isset($_POST['account_nm'])) { ?>
                                ...
                                <table id="table_users" class="table table-responsive">
                                    ...
                                    $sql1 = 'SELECT test.emp_id, accounts.account_nm, test.collection_date, testtype.type_nm, employees.first_nm, employees.last_nm, reasons.reason_nm
                                    FROM (((test INNER JOIN accounts ON test.account_id = accounts.account_id) INNER JOIN testtype ON test.type_id = testtype.type_id) INNER JOIN employees ON (test.emp_id = employees.emp_id) AND (test.account_id = employees.account_id)) INNER JOIN reasons ON test.reason_id = reasons.reason_id
                                    WHERE (((testtype.type_nm) LIKE "'.$_POST['account_nm'].'") '.$sqlDate.')
                                    ORDER BY accounts.account_nm;
