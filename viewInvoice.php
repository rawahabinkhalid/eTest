            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Invoice Report</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                        ...
                        <form action="" method="POST" class="">
                            <div class="row no-print">
                                ...
                                <div class="col-md-3" style="text-align: right">
                                    ...
                                    <button type="button" class="btn mt-2" onclick="window.open('viewInvoice.php', '_self');" style="background-color:#E7D7B7; border-radius:5px; width: 100px;">Reset</button>
                                </div>
                            </div>
                            ...
                            <?php if (
                                ...
                                <table class="table">
                                    ...
                                    $custTotal = 0;
                                    $sql1 =
                                        'SELECT SUM(IFNULL(amount_paid, 0)), accounts.account_id FROM invoice LEFT JOIN accounts  ON invoice.account_id = accounts.account_id WHERE accounts.account_id = ' .
                                        $account_filter .
                                        $sqlDate .
