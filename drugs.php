...
<head>
    ...
    function propertiesClicked() {
        ...
        document.getElementsByClassName('modal-title')[0].innerHTML = 'Edit Drugs';
        $.ajax({
            type: "GET",
            url: "getAllData.php?drugs_id=" + selected_drugs,
            success: function(resultData) {
                var data = JSON.parse(resultData);
                $('#drugs_id').val(selected_drugs);
                $('#drugname').val(data.drug_nm);
            }
        });
    }
    ...
    function deleteClicked() {
        $.ajax({
            type: "GET",
            url: "insert_drugs.php?delete_drug_id=" + selected_drugs,
            success: function(resultData) {
                // console.log(resultData);
                window.open("drugs.php", "_self");
    ...
    function addClicked() {
        document.getElementsByClassName('modal-title')[0].innerHTML = 'New Drugs';
    }

    function drugsSelected(id) {
        $('#table_drugs > tbody  > tr').each(function(index, tr) {
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Drug Maintenance</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="landingscreen.php">Home</a></li>
                                    
                                    <li class="breadcrumb-item active">Drug Maintenance</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                        ...
                        <form action="" method="POST" class="">
                            <div class="row">
                                <div class="col-md-8" style="overflow-y:scroll; overflow-x:scroll;">
                                    <table id="table_drugs" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
...
while ($row = mysqli_fetch_assoc($result)) {
    $id = $row['drug_id'];
    echo '
                                                        <tr id="' . $id . '" onclick="drugsSelected(' . $id . ')">
