            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>Revenue Report</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-3">August 2020 Invoice</div>
                            <div class="col-md-1"></div>
                            <div class="col-md-3">Invoice #213</div>
                            <div class="col-md-1"></div>
                            <div class="col-md-3">TERMS: NET 30 DAYS</div>
                        </div>

                        <div class="row">
                            <div class="col-md-3">LA Dept of Revenue</div>
                            <div class="col-md-5"></div>
                            <div class="col-md-3">Make Payment To</div>
                        </div>

                        <div class="row">
                            <div class="col-md-3">safaig@hsikg.com</div>
                            <div class="col-md-5"></div>
                            <div class="col-md-3">RN Experrtise, Inc</div>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <?php
                                $i=1;
                                $sql = 'SELECT * FROM invoice JOIN lsuform ON invoice.account_id = lsuform.Account JOIN test ON test.invoice_id = invoice.invoice_id JOIN accounts ON invoice.account_id = accounts.account_id';
                                // echo $sql;
