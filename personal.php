            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><b><u>User Information</u></b></h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                    ...
                    <div class="content">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-2"><input readonly name="userid"
                                        value="<?php echo $row['user_id']; ?>" class="form-control"></div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">User Type</div>
                                <div class="col-md-2"><input readonly
                                        value="<?php echo($row['admin'] == 'T') ? 'Administrators' : 'Users'; ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="button" name="" class="btn ml-1"
                                        ...
                                        onclick="window.open('personal.php', '_self');">Reset</button>
                                </div>
                                <!-- <div class="col-md-1">
                                <button type="button" name="" class="btn ml-1"
                                    style="background-color:#E7D7B7; border-radius:5px; width: 100%;"
