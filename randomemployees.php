                                    ...
                                    <table id="table_users" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            if(isset($_GET['account']) && $_GET['account'] != '' && $_GET['account'] != null) {
                                                $sql = 'SELECT * FROM random WHERE account_id = ' . $_GET['account'];
                    ...
                    <form action="insert_random_employee.php" method="post">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="display: inline-block">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12" style="display: inline-block"><input class="" type="checkbox" value="T" id="admin" name="admin">&nbsp;&nbsp;Automatically generate a new
                                    ...
                                    <div class="col-md-12" style="display: inline-block">
                                        <fieldset style="border: 1px solid lightgray; padding: 10px">
                                            ...
                                            <div class="col-md-6" style="display: inline-block">
                                                <input class="form-control" id="totalemployee" name="totalemployee" value="" disabled>
                                            </div>
                                            <div class="col-md-5" style="display: inline-block">Number To Randomize:
                                            </div>
                                            <div class="col-md-6" style="display: inline-block">
                                                <input class="form-control" id="numberToRandomize" name="numberToRandomize" type="number" min="0" max="100" required>
                                            </div>
                                            <div class="col-md-5 mt-2" style="display: inline-block"><input class="" type="checkbox" value="T" id="percentagetick" name="percentagetick">&nbsp;&nbsp;By Percentage:
                                            </div>
                                            <div class="col-md-4 mt-2" style="display: inline-block">
                                                <!-- <input class="form-control" id="pervalue" name="" type="number" min="0" max="100" disabled> -->
                                                <select class="form-control" id="pervalue" name="" disabled>
...
<script>
    $('#pervalue').on('change', function() {
        var value = parseFloat($('#totalemployee').val());
        var percent = parseFloat($('#pervalue').val());
        $('#numberToRandomize').val(Math.ceil((percent / 100) * value))
    })
    $(document).ready(function() {
